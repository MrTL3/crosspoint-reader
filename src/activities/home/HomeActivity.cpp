...
int HomeActivity::getMenuItemCount() const {
  int count = 5;  // File Browser, Recents, Similar Books, File transfer, Settings
  ...
  auto activateSelection = [this] {
    ...
    switch (indexToMenuItem(menuIndex, hasOpdsServers)) {
      ...
      case HomeMenuItem::OPDS_BROWSER:
        onOpdsBrowserOpen();
        break;
      case HomeMenuItem::SIMILAR_BOOKS:
        onSimilarBooksOpen();
        break;
...
void HomeActivity::render(RenderLock&&) {
  ...
  std::vector<const char*> menuItems = {tr(STR_BROWSE_FILES), tr(STR_MENU_RECENT_BOOKS), "Similar Books",
...
void HomeActivity::onSimilarBooksOpen() { activityManager.goToSimilarBooks(); }
